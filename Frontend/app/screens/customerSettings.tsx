...
import useCustomerSettingsManagement from '../hooks/useCustomerSettingsManagement';
...
export default function CustomerSettingsScreen() {
  ...
  const { userDetails, setUserId, handleUserEdit, handleAccountCancellation } = useCustomerSettingsManagement();
  ...
  const handleEditInformation = () => {
    ...
    setFamilySize(userDetails?.familySize?.toString() || '');
    setDefaultMilkQty(userDetails?.defaultMilkQty?.toString() || '');
  ...
  const handleSaveChanges = async () => {
    ...
    const updatedData = {
      ...
      defaultMilkQty: parseInt(defaultMilkQty),
    };
            ...
            <View style={styles.infoContent}>
              ...
              <View style={styles.infoRow}>
                ...
                <View style={styles.infoTextContainer}>
                  ...
                  <Text style={styles.infoValue}>{userDetails?.familySize || 'Not set'}</Text>
                </View>
              </View>
              ...
              <View style={styles.infoRow}>
                <MaterialCommunityIcons name="bottle-soda" size={24} color="#1976D2" />
                <View style={styles.infoTextContainer}>
                  <Text style={styles.infoLabel}>Default Milk Quantity</Text>
                  <Text style={styles.infoValue}>{userDetails?.defaultMilkQty || 'Not set'}</Text>
                </View>
              </View>
            </View>
          </Surface>
            ...
            <Surface style={styles.modalContent}>
              ...
              <ScrollView style={styles.formScrollView}>
                <View style={styles.formContainer}>
                  ...
                  />
                  <TextInput
                    label="Default Milk Quantity"
                    value={defaultMilkQty}
                    onChangeText={setDefaultMilkQty}
                    style={styles.input}
                    mode="outlined"
                    keyboardType="numeric"
                    textColor="#000000"
