    ...
    <View style={styles.drawerContainer}>
      <Drawer.Section title="Menu">
        <Drawer.Item
          ...
          active={true}
          onPress={() => {
            // Additional navigation or actions can be placed here if needed.
        ...
        <Drawer.Item
          ...
          icon="calendar"
          onPress={() => {
            // Navigate to Today's Order screen
            router.push(`/screens/todaysOrder?id=${userId}`); // Make sure this route exists.
          }}
        />
        <Drawer.Item
          label="Settings"
